...
const char * image_names[] = {   
	...
	"cards_png/1_4.png", "cards_png/1_5.png", "cards_png/1_6.png", "cards_png/1_7.png",
	"cards_png/1_8.png", "cards_png/1_9.png", "cards_png/1_j.png", "cards_png/1_q.png",
	"cards_png/1_k.png",

	"cards_png/2_0.png", "cards_png/2_1.png", "cards_png/2_2.png", "cards_png/2_3.png",
	"cards_png/2_4.png", "cards_png/2_5.png", "cards_png/2_6.png", "cards_png/2_7.png",
	"cards_png/2_8.png", "cards_png/2_9.png", "cards_png/2_j.png", "cards_png/2_q.png",
	"cards_png/2_k.png",

	"cards_png/3_0.png", "cards_png/3_1.png", "cards_png/3_2.png", "cards_png/3_3.png",
	"cards_png/3_4.png", "cards_png/3_5.png", "cards_png/3_6.png", "cards_png/3_7.png",
	"cards_png/3_8.png", "cards_png/3_9.png", "cards_png/3_j.png", "cards_png/3_q.png",
	"cards_png/3_k.png",	
...
Glib::RefPtr<Gdk::Pixbuf> DeckGUI::getCardImage( Faces_ f, Suits_ s ) {
